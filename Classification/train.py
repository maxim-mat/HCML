...
parser.add_argument('save_path', default=None, metavar='SAVE_PATH', type=str,
                    help="Path to the saved Diffusion")
        ...
        if summary['step'] % cfg.test_every == 0:
            ...
            for t in range(len(cfg.num_classes)):
                ...
                summary_writer.add_scalar(
                    ...
                    summary['step'])
            summary_writer.add_scalar('dev/auc_mean', summary_dev['auc'].mean(), summary['step'])
    ...
    for epoch in range(epoch_start, cfg.epoch):
        ...
        for t in range(len(cfg.num_classes)):
            ...
            summary_writer.add_scalar(
                'dev/auc_{}'.format(dev_header[t]), summary_dev['auc'][t],
                summary_train['step'])
        summary_writer.add_scalar('dev/auc_mean', summary_dev['auc'].mean(), summary_train['step'])
